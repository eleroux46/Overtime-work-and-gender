...
/* Import database "Postes" 2018 */

data post1 (keep = &keepvars) ; 
set "\\casd.fr\casdfs\Projets\ENSAE04\Data\DADS_DADS Postes_2018\post_1.sas7bdat"; 
if cmiss(of SEXE PCS S_BRUT SIREN) then delete;
if A6 = "OQ" then delete;
run;

data post2 (keep = &keepvars) ; 
set "\\casd.fr\casdfs\Projets\ENSAE04\Data\DADS_DADS Postes_2018\post_2.sas7bdat"; 
if cmiss(of SEXE PCS S_BRUT SIREN) then delete;
if A6 = "OQ" then delete;
run;

data post3 (keep = &keepvars) ; 
set "\\casd.fr\casdfs\Projets\ENSAE04\Data\DADS_DADS Postes_2018\post_3.sas7bdat"; 
if cmiss(of SEXE PCS S_BRUT SIREN) then delete;
if A6 = "OQ" then delete;
run;

data post4 (keep = &keepvars) ; 
set "\\casd.fr\casdfs\Projets\ENSAE04\Data\DADS_DADS Postes_2018\post_4.sas7bdat";
if cmiss(of SEXE PCS S_BRUT SIREN) then delete;
if A6 = "OQ" then delete;
run;
...
data post18_ent (keep = A6 DEPT DOMEMPL DOMEMPL_EMPL FRONTALIER SIREN TREFFECT TREFFEN UUT APEN);
set post18_c;
RUN;
...
proc sort data= post18_c_ent ;
by SIREN;
RUN;

proc sort data= post18_ent out=post18_ent_u nodupkey ; 
by SIREN;
RUN;
...
data base18;
merge post18_c_ent fe18 ho18 post18_ent_u overt18;
by SIREN;
...
PROC EXPORT data=base18
outfile= "C:\Users\Public\Documents\Leroux_Mayans\Data\base18_siren2.csv"
dbms=csv
replace;
run;
